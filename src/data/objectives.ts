export default [
	...
	},
	{
		...
		implementations: [
			...
			{
				orientations: [2],
				explanation: 'Aménagement de corridors sécurisés dédiés au déplacement actif'
			}
		],
	...
	},
	{
		...
		implementations: [
			{
				orientations: [1],
				explanation: 'Identification des lieux de conservation des milieux naturels'
			},
			{
				orientations: [2],
				explanation: 'Aménagement d’un corridor des pollinisateurs'
			}
		],
		color: 'rgb(86, 192, 43)'
	},
	{
		...
		description: 'Partenariats pour la réalisation des objectifs',
		implementations: [
			{
				orientations: null,
