...
<div class="text-wrap">
	...
	<p>
		Localisée sur la Rive-Sud de Montréal, la <Link
			rel="external"
		...
		cours des prochaines années, de plusieurs projets d’infrastructures et de développement urbain.
		Afin d’alimenter la planification de ces projets, la Ville de Saint-Constant s’interroge sur
		la portée de ses interventions sur ses paysages, autant du point de vue de ses résidents que
		des visiteurs. À cette fin, la ville désire se doter d’outils pour
		<strong
	...
	<p>
		...
		> et en appui avec la <Link rel="external" href="https://saint-constant.ca/"
			>Ville de Saint-Constant</Link
		> et la <Link rel="external" href="https://roussillon.ca/">MRC de Roussillon</Link>,
		l’expertise de la <Link rel="external" href="https://paysage.umontreal.ca"
			>Chaire en paysage et environnement de l’Université de Montréal (CPEUM)</Link
		> et de la <Link rel="external" href="https://unesco-paysage.umontreal.ca"
			>Chaire UNESCO en paysage urbain (CUPUM)</Link
		> de la même institution a été mise à profit pour développer de
		<strong
			>nouveaux outils et de nouvelles approches de planification territoriale plus sensibles
			aux valorisations sociales et culturelles des paysages</strong
		>.
	</p>
</div>
<Logos />
...
<List class="left">
	...
	<ListItem>
		Co-réaliser un modèle stratégique innovant de mise en valeur et de développement des
		paysages urbains;
	</ListItem>
	<ListItem>
...
<p class="bg" style="--bgtop: -40rem; --bgbottom: -4rem">
	...
	> Celles-ci se déclinent selon trois grandes orientations qui reposent sur la lecture des attraits
	du territoire, des préoccupations et des aspirations entretenues envers les paysages qui ont été
	dégagés dans le cadre de la phase de diagnostic du projet&nbsp;:
</p>
<Orientations />
<p class="bg" style="--bgtop: -4rem; --bgbottom: -20rem">
	Ces orientations découlent des propositions d’aménagement formulées au cours de la phase
	d’idéation. Les propositions d’aménagement présentées sont assorties d’une <strong
		>charte de principes directeurs susceptibles d’assurer, à terme, la cohérence des actions en
		vue de la préservation, de la mise en valeur et du développement des attraits des paysages
		de la Ville de Saint-Constant</strong
	>.
</p>
