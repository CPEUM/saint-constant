<script lang="ts">
	...
	import ExcerptButton from '$components/excerpt/ExcerptButton.svelte';
	...
	import PropositionHeader from '$components/exercice/PropositionHeader.svelte';
	import Ribbon from '$components/exercice/Ribbon.svelte';
	import RibbonSlide from '$components/exercice/RibbonSlide.svelte';
...
<Exercice key="agroparc">
	<!-- <Concept heading="Le concept d’agroparc">
		...
		<ExcerptButton name="Agroparc1">Quelques références supplémentaires d'agroparcs</ExcerptButton>
	...
	<Propositions>
		...
		<Ribbon>
			<RibbonSlide>
				<PropositionHeader label="Site A" title="Le secteur agricole du bassin de rétention de la rue Chantal" src="/media/agroparc/3-1-6.jpg" />
			</RibbonSlide>
			<RibbonSlide>
				<FigureMap
					bounds={[
			...
			<RibbonSlide>
				...
				<ExcerptButton style="position: absolute; bottom: 2rem; left: 2rem;" name="Agroparc2">Pour les curieux&nbsp;: Agriculture bio-intensive</ExcerptButton>
			</RibbonSlide>
			<RibbonSlide width="700px">
				<p>
			...
			<RibbonSlide width="700px">
				...
				<p>
					...
					de plus en plus au Québec et démontrent la productivité et la rentabilité de ces méthodes plus respectueuses de l’environnement. Ces terres pourront être divisées et se répartir entre
					plusieurs producteurs pour une plus grande variété de production. Chaque exploitation est dotée d’un kiosque qui sert à la fois de point de vente direct et de hangar de rangement du
					matériel. Des haies brises vents sont suggérées afin de structurer chacune des exploitations, favoriser la biodiversité, la qualité des sols, protéger les cultures des vents et augmenter
				...
				<p>
					...
					fois d’offrir une visibilité aux producteurs et de sensibiliser le public aux nouvelles pratiques innovantes, favoriser les circuits courts (proximité entre les lieux de
					production, distribution et consommation) et transformer ces espaces en milieux de vie mixte.
				</p>
			</RibbonSlide>
